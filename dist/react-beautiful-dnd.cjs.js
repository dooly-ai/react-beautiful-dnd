...
var _inheritsLoose = _interopDefault(require('@babel/runtime-corejs3/helpers/inheritsLoose'));
...
var _extends = _interopDefault(require('@babel/runtime-corejs3/helpers/extends'));
var redux = require('redux');
var reactRedux = require('react-redux');
var _everyInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/every'));
...
var _sortInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/sort'));
var memoizeOne = _interopDefault(require('memoize-one'));
var _reduceInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/reduce'));
var _sliceInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/slice'));
var _findInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/find'));
var _findIndexInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/find-index'));
var _Object$values = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/object/values'));
var _indexOfInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/index-of'));
...
var _setTimeout = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/set-timeout'));
var _spliceInstanceProperty = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/instance/splice'));
var _Date$now = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/date/now'));
var _Object$assign = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/object/assign'));
var ReactDOM = _interopDefault(require('react-dom'));
var _Number$isInteger = _interopDefault(require('@babel/runtime-corejs3/core-js-stable/number/is-integer'));
...
var clean = function clean(value) {
  ...
  return _trimInstanceProperty(_context = value.replace(spacesAndTabs, ' ').replace(lineStartWithSpaces, '')).call(_context);
};
...
var warning = _bindInstanceProperty(log).call(log, null, 'warn');
var error = _bindInstanceProperty(log).call(log, null, 'error');
...
function bindEvents(el, bindings, sharedOptions) {
  var unbindings = _mapInstanceProperty(bindings).call(bindings, function (binding) {
  ...
  return function unbindAll() {
    _forEachInstanceProperty(unbindings).call(unbindings, function (unbind) {
      unbind();
    });
  };
}
...
var closest = function closest(target, points) {
  return Math.min.apply(Math, _mapInstanceProperty(points).call(points, function (point) {
...
function findIndex(list, predicate) {
  if (_findIndexInstanceProperty(list)) {
    return _findIndexInstanceProperty(list).call(list, predicate);
  }
...
function find(list, predicate) {
  if (_findInstanceProperty(list)) {
    return _findInstanceProperty(list).call(list, predicate);
  }
...
function toArray(list) {
  return _sliceInstanceProperty(Array.prototype).call(list);
}

var toDroppableMap = memoizeOne(function (droppables) {
  return _reduceInstanceProperty(droppables).call(droppables, function (previous, current) {
    previous[current.descriptor.id] = current;
    return previous;
  }, {});
});
var toDraggableMap = memoizeOne(function (draggables) {
  return _reduceInstanceProperty(draggables).call(draggables, function (previous, current) {
    previous[current.descriptor.id] = current;
    return previous;
  }, {});
});
...
var getDraggablesInsideDroppable = memoizeOne(function (droppableId, draggables) {
  ...
  var result = _sortInstanceProperty(_context = _filterInstanceProperty(_context2 = toDraggableList(draggables)).call(_context2, function (draggable) {
...
var removeDraggableFromList = memoizeOne(function (remove, list) {
  return _filterInstanceProperty(list).call(list, function (item) {
...
function getDisplacementGroups(_ref) {
  var afterDragging = _ref.afterDragging,
      ...
      last = _ref.last;
  return _reduceInstanceProperty(afterDragging).call(afterDragging, function process(groups, draggable) {
...
function calculateReorderImpact(_ref2) {
  ...
  var sliceFrom = _indexOfInstanceProperty(insideDestination).call(insideDestination, match);

  var impacted = _sliceInstanceProperty(withoutDragging).call(withoutDragging, sliceFrom);
...
function getDraggables(ids, draggables) {
  return _mapInstanceProperty(ids).call(ids, function (id) {
...
var speculativelyIncrease = (function (_ref) {
  ...
  _forEachInstanceProperty(_context = last.all).call(_context, function (id) {
...
var getBestCrossAxisDroppable = (function (_ref) {
  ...
  var candidates = _filterInstanceProperty(_context = _sortInstanceProperty(_context2 = _filterInstanceProperty(_context3 = _filterInstanceProperty(_context4 = _filterInstanceProperty(_context5 = _filterInstanceProperty(_context6 = _filterInstanceProperty(_context7 = _filterInstanceProperty(_context8 = toDroppableList(droppables)).call(_context8, function (droppable) {
  ...
  var contains = _filterInstanceProperty(candidates).call(candidates, function (droppable) {
  ...
  if (contains.length > 1) {
    return _sortInstanceProperty(contains).call(contains, function (a, b) {
      return getKnownActive(a)[axis.start] - getKnownActive(b)[axis.start];
    })[0];
  }

  return _sortInstanceProperty(candidates).call(candidates, function (a, b) {
...
var getClosestDraggable = (function (_ref) {
  ...
  var sorted = _sortInstanceProperty(_context = _filterInstanceProperty(insideDestination).call(insideDestination, function (draggable) {
...
var getRequiredGrowthForPlaceholder = function getRequiredGrowthForPlaceholder(droppable, placeholderSize, draggables) {
  ...
  var spaceUsed = _reduceInstanceProperty(insideDroppable).call(insideDroppable, function (sum, dimension) {
...
function getFurthestAway(_ref) {
  ...
  var sorted = _sortInstanceProperty(_context = _mapInstanceProperty(candidates).call(candidates, function (candidate) {
...
function getDroppableOver$1(_ref2) {
  ...
  var candidates = _filterInstanceProperty(_context2 = toDroppableList(droppables)).call(_context2, function (item) {
    if (!item.isEnabled) {
      return false;
    }
...
var getLiftEffect = (function (_ref) {
  ...
  var rawIndex = _indexOfInstanceProperty(insideHome).call(insideHome, draggable);

  !(rawIndex !== -1) ? process.env.NODE_ENV !== "production" ? invariant(false, 'Expected draggable to be inside home list') : invariant(false) : void 0;

  var afterDragging = _sliceInstanceProperty(insideHome).call(insideHome, rawIndex + 1);

  var effected = _reduceInstanceProperty(afterDragging).call(afterDragging, function (previous, item) {
...
var adjustAdditionsForScrollChanges = (function (_ref) {
  ...
  return _mapInstanceProperty(additions).call(additions, function (draggable) {
...
var publishWhileDraggingInVirtual = (function (_ref) {
  ...
  var withScrollChange = _mapInstanceProperty(_context = published.modified).call(_context, function (update) {
  ...
  _forEachInstanceProperty(_context2 = published.removals).call(_context2, function (id) {
...
var reducer = (function (state, action) {
  ...
  if (action.type === 'INITIAL_PUBLISH') {
    ...
    var isWindowScrollAllowed = _everyInstanceProperty(_context = toDroppableList(dimensions.droppables)).call(_context, function (item) {
...
function checkIndexes(insideDestination) {
  ...
  var indexes = _mapInstanceProperty(insideDestination).call(insideDestination, function (d) {
  ...
  var formatted = _mapInstanceProperty(indexes).call(indexes, function (index) {
...
var getAsyncMarshal = (function () {
  ...
  var execute = function execute(timerId) {
    ...
    var _entries$splice = _spliceInstanceProperty(entries).call(entries, index, 1),
  ...
  var flush = function flush() {
    ...
    var shallow = _concatInstanceProperty(_context = []).call(_context, entries);

    entries.length = 0;

    _forEachInstanceProperty(shallow).call(shallow, function (entry) {
...
function createPublisher(_ref) {
  ...
  var collect = function collect() {
    ...
    frameId = requestAnimationFrame(function () {
      ...
      var added = _sortInstanceProperty(_context = _mapInstanceProperty(_context2 = _Object$keys(additions)).call(_context2, function (id) {
        return registry.draggable.getById(id).getDimension(origin);
      })).call(_context, function (a, b) {
        return a.descriptor.index - b.descriptor.index;
      });

      var updated = _mapInstanceProperty(_context3 = _Object$keys(modified)).call(_context3, function (id) {
...
var getInitialPublish = (function (_ref) {
  ...
  var droppables = _mapInstanceProperty(_context = registry.droppable.getAllByType(home.type)).call(_context, function (entry) {
    return entry.callbacks.getDimensionAndWatchScroll(windowScroll, scrollOptions);
  });

  var draggables = _mapInstanceProperty(_context2 = registry.draggable.getAllByType(critical.draggable.type)).call(_context2, function (entry) {
...
var createDimensionMarshal = (function (registry, callbacks) {
  ...
  var stopPublishing = function stopPublishing() {
    ...
    _forEachInstanceProperty(_context = registry.droppable.getAllByType(home.type)).call(_context, function (entry) {
...
var getScrollableDroppables = memoizeOne(function (droppables) {
  ...
  return _filterInstanceProperty(_context = toDroppableList(droppables)).call(_context, function (droppable) {
...
var getStyles = function getStyles(rules, property) {
  return _mapInstanceProperty(rules).call(rules, function (rule) {
...
function createRegistry() {
  ...
  function subscribe(cb) {
    ...
    return function unsubscribe() {
      var index = _indexOfInstanceProperty(subscribers).call(subscribers, cb);

      if (index === -1) {
        return;
      }

      _spliceInstanceProperty(subscribers).call(subscribers, index, 1);
    };
  }

  function notify(event) {
    if (subscribers.length) {
      _forEachInstanceProperty(subscribers).call(subscribers, function (cb) {
        return cb(event);
      });
    }
  }
  ...
  var draggableAPI = {
    ...
    getAllByType: function getAllByType(type) {
      ...
      return _filterInstanceProperty(_context = values(entries.draggables)).call(_context, function (entry) {
  ...
  var droppableAPI = {
    ...
    getAllByType: function getAllByType(type) {
      ...
      return _filterInstanceProperty(_context2 = values(entries.droppables)).call(_context2, function (entry) {
        return entry.descriptor.type === type;
      });
    }
  };
...
function useMouseSensor$1(api) {
  ...
  var startPendingDrag = useMemoOne.useCallback(function startPendingDrag(actions, point) {
    ...
    var longPressTimerId = _setTimeout(startDragging, timeForLongPress);
...
function tryStart(_ref3) {
  ...
  var tryDispatchWhenDragging = _bindInstanceProperty(tryDispatch).call(tryDispatch, null, 'DRAGGING');
...
function useSensorMarshal(_ref4) {
  ...
  var useSensors = _concatInstanceProperty(_context = []).call(_context, enableDefaultSensors ? defaultSensors : [], customSensors || []);
...
function Placeholder(props) {
  ...
  React.useEffect(function () {
    ...
    animateOpenTimerRef.current = _setTimeout(function () {
      animateOpenTimerRef.current = null;
      setIsAnimatingOpenOnMount(false);
    });
...
function runChecks(args, checks) {
  _forEachInstanceProperty(checks).call(checks, function (check) {
    return check(args);
  });
}
...
var AnimateInOut = function (_React$PureComponent) {
  ...
  function AnimateInOut() {
    ...
    _this = _React$PureComponent.call.apply(_React$PureComponent, _concatInstanceProperty(_context = [this]).call(_context, args)) || this;
    _this.state = {
